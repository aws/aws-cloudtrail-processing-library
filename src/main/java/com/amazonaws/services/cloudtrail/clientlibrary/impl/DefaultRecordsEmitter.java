...
/**
 * Default no-ops RecordsEmitter implementation.
 */
public class DefaultRecordsEmitter implements RecordsProcessor {

	@Override
	public void process(List<ClientRecord> record, AWSCloudTrailClientConfiguration config) {
        // do nothing
	}
}
