...
public class LogDeliveryInfo implements CloudTrailDeliveryInfo{
     ...
     * @param charStart the location of the record's starting character
     * @param charEnd the location of the record's ending character
     * @param rawRecord the CloudTrail record in raw String - as it is in the log file
     */
