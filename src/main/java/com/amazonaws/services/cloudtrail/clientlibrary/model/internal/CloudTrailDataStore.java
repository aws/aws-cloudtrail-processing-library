...
public class CloudTrailDataStore {
    /**
     * Store underlining data into a map.
     */
    ...
    /**
     * Internal use only. To add key value pair to underlining data store.
     *
     * @param key
     * @param value
     */
    ...
    /**
     * To retrieve value based on key from underlining data store.
     *
     * @param key
     * @return
     */
