...
public class BasicProcessingConfiguration implements ProcessingConfiguration{
    ...
    public BasicProcessingConfiguration(String sqsUrl, AWSCredentialsProvider awsCredentialsProvider) {
        this.sqsUrl = sqsUrl;
