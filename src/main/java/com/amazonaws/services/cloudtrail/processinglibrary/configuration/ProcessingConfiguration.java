...
/**
 * AWSCloudTrailProcessingConfiguration is used to configure RecordReader. The user either
 * pass use System properties file to load configuration or create AWSCloudTrailProcessingConfiguration
