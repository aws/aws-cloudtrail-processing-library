 ...
 * services were accessed, what action was performed, and any parameters for the action. The request
 * also helps determine who made the request. The event data is enclosed in a Records array.
 *
